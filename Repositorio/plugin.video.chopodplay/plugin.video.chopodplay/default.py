...
def main_list(params):
    ...
    plugintools.add_item(action = "plugin.video.discoveryplus" , title = "[B][LOWERCASE][CAPITALIZE][COLOR white]puedes instalarlo pinchando [COLOR lime]aqui  [/CAPITALIZE][/LOWERCASE][/B][/COLOR]",thumbnail ="https://static.wikia.nocookie.net/logopedia/images/a/a6/Discovery_Plus_logo_%28stacked%29.png/revision/latest?cb=20201227091030", fanart = "https://www.exchange4media.com/news-photo/105426-image8.jpg",url= "plugin://plugin.video.discoveryplus", folder = True )      
