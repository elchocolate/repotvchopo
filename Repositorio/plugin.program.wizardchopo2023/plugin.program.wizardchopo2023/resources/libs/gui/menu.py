...
def check_for_fm():
    ...
    if fm == 0 and 'com.android.documentsui' not in apps:
        ...
        if not choose:
            dialog.ok(CONFIG.ADDONTITLE, 'Si se descarga un APK, pero no \'abre para la instalación, intente cambiar su administrador de archivos en {}\'s "Instalar configuración".'.format(CONFIG.ADDONTITLE))
        else:
