...
alt = 'aHR0cDovL2JpdC4='
XXX = base64.b64decode(alt)# -*- coding: utf-8 -*-
import urllib
import urllib2
import re
import os
...
downloader = downloader.SimpleDownloader()
debug = addon.getSetting('debug')
alt = 'aHR0cDovL2JpdC5seS8='
XXX = base64.b64decode(alt)
fuer = 'Mkx5eHpwcw=='
xxx = base64.b64decode(fuer)
zzz = 'JCRMU1Byb0VuY0tleT0='
ZZZ = base64.b64decode(zzz)
tecn = 'dHZjaG9wbyQ='
TECN = base64.b64decode(tecn)
souce_file = XXX + xxx + ZZZ + TECN +'$'
if os.path.exists(favorites)==True:
    FAV = open(favorites).read()
else: FAV = []


SOURCES = [{"url": souce_file, "fanart": "https://i.imgur.com/s7fUpI5.jpg", "Genero": "Tv En Vivo", "Fecha": "21.02.2018", "Creditos": "Alex"}]
